            ...
            Android_GerenciaEstadoTheme {
                Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
                    Column {
                        ...
                        ContadorStateless(contador, onIncrementContador = {viewModel.incrementar()}, onDecrimentContador = {viewModel.decrementar()}, modifier = Modifier.padding(innerPadding))
...
@Composable
fun ContadorStateless(contador: Int, onIncrementContador: () -> Unit, onDecrimentContador: () -> Unit, modifier: Modifier = Modifier) {
    ...
    Column(modifier, horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        Button(onClick = onDecrimentContador) {
